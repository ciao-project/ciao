...
func (c *controller) validateBlockDeviceAutoEphemeral(bd api.BlockDeviceMappingV2) (bool, error) {
...
func (c *controller) validateBlockDeviceAuto(bd api.BlockDeviceMappingV2) (bool, error) {
...
func (c *controller) validateBlockDevicePreCreated(bd api.BlockDeviceMappingV2, nInstances int) (bool, error) {
...
func (c *controller) validateBlockDeviceMappings(blockDeviceMappings []api.BlockDeviceMappingV2, nInstances int) error {
...
func isBootable(volume api.BlockDeviceMappingV2) bool {
...
func abstractBlockDevices(blockDeviceMappings []api.BlockDeviceMappingV2) (volumes []storage.BlockDevice) {
	for _, bd := range blockDeviceMappings {
