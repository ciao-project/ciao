...
// GetResult adds behavior for supporting more token-information gathering
type GetResult v3tokens.GetResult

// ExtractProject extracts project from token result structure
