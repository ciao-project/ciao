...
func init() {
	...
	setupCmd.Flags().StringVar(&clusterConf.KeystoneServiceUser, "keystone-service-user", "csr", "Username for controller to access keystone (service user)")
	setupCmd.Flags().StringVar(&clusterConf.KeystoneServicePassword, "keystone-service-password", "", "Password for controller to access keystone (service user)")
	setupCmd.Flags().StringVar(&clusterConf.KeystoneAdminUser, "keystone-admin-user", "admin", "Username for client to access keystone (admin user)")
	setupCmd.Flags().StringVar(&clusterConf.KeystoneAdminPassword, "keystone-admin-password", "", "Password for client to access keystone (admin user)")
	setupCmd.Flags().StringVar(&clusterConf.KeystoneURL, "keystone-url", "", "URL for keystone server")
