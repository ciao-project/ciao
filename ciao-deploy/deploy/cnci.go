...
// CopyImageToTemp copies file to temporary file
// TODO: remove?
func CopyImageToTemp(baseImage string) (string, error) {
	dst, err := ioutil.TempFile("", "cnci-image")
	if err != nil {
		return "", errors.Wrap(err, "Error creating temporary image file")
	}
